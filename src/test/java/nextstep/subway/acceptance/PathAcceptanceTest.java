...
public class PathAcceptanceTest extends BasicAcceptanceTest{
    ...
    class successCase {
        ...
        void successFindPath() {
            ...
            //when
            var response = PathCommonApi.findLinePath(남부터미널역, 역삼역, "DISTANCE");
    ...
    class failCase {
        ...
        void failFindPathWhenSameEdgeStation() {
            ...
            //when
            var response = PathCommonApi.findLinePath(남부터미널역, 남부터미널역, "DISTANCE");
        ...
        void failFindPathWhenNotConnected() {
            ...
            //when
            var response = PathCommonApi.findLinePath(석남역, 남부터미널역, "DISTANCE");
        ...
        void failFindPathWhenNotExist() {
            ...
            //when
            var response = PathCommonApi.findLinePath(12312L, 79L, "DISTANCE");
